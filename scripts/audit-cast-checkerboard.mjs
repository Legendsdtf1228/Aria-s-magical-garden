/**
 * Checkerboard audit — all eight poc-cast-v1 sprites on contrasting grid.
 */
import sharp from "sharp";
import { existsSync } from "fs";
import { join } from "path";

const CAST = "public/art/characters/poc-cast-v1";
const OUT = "docs/review/v5/phaser-poc/CAST-AUDIT-CHECKERBOARD.png";
const CELL = 280;
const COLS = 4;
const ROWS = 2;
...
const files = ORDER.filter((f) => existsSync(join(CAST, f)));
...
console.log("wrote", OUT, files.length, "sprites");
